//Create for Lucas Veloso on 2019
// Automation for IESDE institute. 
...
public class GerarTermo {
	...
	public static void main(String[] args) {
            ...
            //new adhesion contract
            driver.findElement(By.xpath("//a[@class='btn btn-primary'][contains(.,'Novo')]")).click();

        //after the first adhesion the others will be done in the same browser
        int i=0;
        for(i=0; i<=3; i++) {
            ...
            //open new tab for register new adhesion
            if(i<3) {
                jse.executeScript("window.open('http://ead.portalava.com.br.lab08.dev.iesde.com.br/administrador/matriculas/gerar-termo/0','_blank');");
            }
        }
    }
